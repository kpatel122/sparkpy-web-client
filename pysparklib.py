...
def CreateEnvironment(environmentName, location=0):
    ...
    :type location:int, defaults to 0
    :return: None
    '''
...
def CreateCharacter(characterName,x=0,y=0,z=0):
    ...
    :return: characterID- unique ID of the character
    '''
    #create parameter string
...
def ChatBubble(characterID, text, seconds):
    '''Displays a chat bubble above the character with 'text' for 'seconds'  
    :param characterID: The characterID to rotate
    :type characterID: int
    :param text: the text for the chat bubble
    :type text:string
...
def PlayCharacterSound(characterID, clipname, volume = 1.0 ,loop = False):
    ...
    :param loop: whether to loop back to the beginning of the clip when finished
    :type loop:bool, defaults to False
    :return: 0 on failure or 1 on success
    '''
...
def CreatePrimitive(primitiveType, x=0, y=0, z=0):
    ...
    :param x: x position
    :type x: float, defaults to 0
    :param y: y position
    :type y: float, defaults to 0
    :param z: z position
    :type z: float, defaults to 0
    :return: primitiveID- unique ID of the primitive
    '''
...
def SetPrimitiveColour(primitiveID, red, green,blue,alpha=1):
    ...
    :type alpha:float, defaults to 1
    :return: 0 on failure or 1 on success
    '''
...
def CreateEffect(effectName, x=0, y=0, z=0,scale=1):
    ...
    :type scale: float, defaults to 1
    :return: effectID- unique ID of the effect
    '''
...
def SetEffectColour(effectID, startColour,endColour="white"):
    ...
    :type endColour: string, defaults to white 
    :return: 0 on failure or 1 on success
    '''
